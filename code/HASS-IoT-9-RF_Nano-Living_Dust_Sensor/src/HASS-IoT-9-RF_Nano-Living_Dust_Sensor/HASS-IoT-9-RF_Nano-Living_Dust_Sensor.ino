...
#define MEASUREMENT_INTERVAL 10                    // Seconds between measurements. How many seconds between measurements? Recommended is at least 120 seconds. The minimum is 15 seconds.
...
#define MY_NODE_ID 9                             // Giving a node a manual ID can in rare cases fix connection issues.
...
void presentation()
{
  ...
  sendSketchInfo(F("Living Fine dust sensor"), F("1.1"));
